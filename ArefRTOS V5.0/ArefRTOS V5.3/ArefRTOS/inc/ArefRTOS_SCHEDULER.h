...
/***********************************************************
* 		  BINARY SEMAPHORE FUNCTIONS PROTOTYPES			   *
************************************************************/
#if BINARY_SAMPHORE_ENABLE == Enable
/*
 * @brief This Function is used to take a Semaphore .
 * @param an object from @ref ArefRTOS_BinarySamphore
 * @return ArefRTOS_ErrorID return one of @ref ArefRTOS_ErrorID
 */
ArefRTOS_ErrorID ArefRTOS_AquireBinarySemaphore(ArefRTOS_BinarySemaphore *pSemaphore);
/*
 ...
 * @param pSamphore   an object from @ref ArefRTOS_BinarySamphore
