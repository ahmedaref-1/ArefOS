...
#include "PLATFORMTYPES.h"			// Include the platform data types typedefs
...
/***********************************************************
* 														   *
*	     USER PRE-PROCESSOR CONFIGURATION OPTIONS          *
*														   *
************************************************************/
/*
 * @brief This Macro is used to Enable mutual exclusion (MUTEX)
 */
#define MUTEX_ENABLE			Enable

/*
 * @brief This Macro is used to Enable Message Queue
 */
#define QUEUE_MESSAGE_BOX_ENABLE 		Enable
#if 	QUEUE_MESSAGE_BOX_ENABLE   == 	Enable
	/*
	 * @brief This Macro is used to define MAX size of Queue for data synch
	 */
	#define MESSAGE_QUEUE_MAX_SIZE			10
#endif

/*
 * @brief This Macro is used to Enable Binary Semaphore
 */
#define BINARY_SAMPHORE_ENABLE				Enable
...
#define ArefRTOS_SVC_REQUEST3 				3
 ...
 * details  Initializes the System Timer and its interrupt, and starts the System Tick Timer.
            Counter is in free running mode to generate periodic interrupts of constant interval 1mS.
 *@param   void
 *@return  void
 */
